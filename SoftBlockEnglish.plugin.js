...
module.exports = (() => {
    const config = {
        ...
        "info": {
            ...
            "authors": [{
                "name": "ikeman2003",
                "github_username": "ikeman2003"
            }],
            "version": "1.0.3",
            "description": "Disable the messages from people you like enough not to block them but don't wanna see them in specific or all channels.",
            "github": "https://github.com/ikeman2003/BDAddons",
            "github_raw": "https://raw.githubusercontent.com/ikeman2003/BDAddons/master/SoftBlockEnglish.plugin.js"
        },
        "changelog": {
            "improved": {
                "Clarity": "Simplifed translation to make more sense and be more descriptive."
            }
        },
        "defaultConfig": [{
            "type": "textbox",
            "id": "blocked",
            "name": "Blocked",
            "note": "User ID for the person(s) to be softblocked separated by \",\"",
            "value": "",
            "placeholder": "178896511378259968, 416275248153886720"
        }, {
            "type": "textbox",
            "id": "servers",
            "name": "Impacted servers",
            "note": "Server ID for the server(s) that will be impacted separated by \",\"",
            "value": "",
            "placeholder": "727082219318935562, 700448965661032550"
        }, {
            "type": "switch",
            "id": "useEverywhere",
            "name": "Activate everywhere",
            "note": "Overrides the permissions of impacted servers and activates globally.",
            "value": true
        }, {
            "type": "switch",
            "id": "showDm",
            "name": "Display DMs",
            "note": "Leave the user unblocked and keeps messages visible in private DM's.",
            "value": false
        }, {
            "type": "switch",
            "id": "showGuild",
            "name": "Display in Servers",
            "note": "Leave user unblocked and messages visible in servers and channels.",
            "value": false
        }, {
            "type": "switch",
            "id": "showTyping",
            "name": "View \"typing\"",
            "note": "Show when softblocked users are typing.",
            "value": true
        }, {
            "type": "switch",
            "id": "showReplies",
            "name": "Show Replies",
            "note": "Show when a softblocked user replies directly to your message.",
            "value": false
        }, {
            "type": "switch",
            "id": "showMembers",
            "name": "Display in the members list",
            "note": "Leave softblocked users in the member list.",
            "value": false
        }]
    };
